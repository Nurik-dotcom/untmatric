...
const SUITES: Array[Dictionary] = [
	...
	{"name": "RestoreQuestBSemantics", "path": "res://tests/test_restore_quest_b_semantics.gd"},
	{"name": "DisarmQuestCSemantics", "path": "res://tests/test_disarm_quest_c_semantics.gd"},
